...
describe('Requests API Route', () => {
    ...
    describe('GET /requests - All Requests from every Event', () => {
        ...
        it('should error if :eventID is not in authorized users workspace', () => {
            expect(true).true
        })
        it('should return authorized users event based on eventID', () => {
            expect(true).true
        })
    ...
    describe('DELETE /:eventID/:requestID - Delete Request Record', () => {
        it('should error if not authorized', () => {
            expect(true).true
        })
